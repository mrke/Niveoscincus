...
%%
function [par, metapar, txt_par, chem] = pars_init_Niveoscincus_microlepidotus(metadata)
...
%% primary parameters
par.z = 1.815;     free.z     = 1;    units.z = '-';          label.z = 'z';          % zoom factor; for z = 1: L_m = 1 cm
...
par.v = 0.04184;       free.v     = 1;    units.v = 'cm/d';       label.v = 'v';          % energy conductance
par.kap = 0.6433;      free.kap   = 1;    units.kap = '-';        label.kap = 'kap';      % allocation fraction to soma
par.kap_R = 0.95;   free.kap_R = 0;    units.kap_R = '-';      label.kap_R = 'kap_R';  % reproduction efficiency
par.p_M = 31.82;       free.p_M   = 1;    units.p_M = 'J/d.cm^3'; label.p_M = '[p_M]';    % vol-spec somatic maint
par.p_T =  0;       free.p_T   = 0;    units.p_T = 'J/d.cm^2'; label.p_T = '{p_T}';    % surf-spec somatic maint
par.k_J = 0.002;    free.k_J   = 1;    units.k_J = '1/d';      label.k_J = 'k_J';      % maturity maint rate coefficient
par.E_G = 7793;     free.E_G   = 1;    units.E_G = 'J/cm^3';   label.E_G = '[E_G]';    % spec cost for structure
par.E_Hb = 2068;    free.E_Hb  = 1;    units.E_Hb = 'J';       label.E_Hb = 'E_Hb';    % maturity at birth
par.E_Hp = 1.05e+04;      free.E_Hp  = 1;    units.E_Hp = 'J';       label.E_Hp = 'E_Hp';    % maturity at puberty
par.h_a = 1.086e-09;     free.h_a   = 1;    units.h_a = '1/d^2';    label.h_a = 'h_a';      % Weibull aging acceleration
par.s_G = 1e-4;     free.s_G   = 0;    units.s_G = '-';        label.s_G = 's_G';      % Gompertz stress coefficient

%% auxiliary parameters
par.T_A   = 10191;   free.T_A   = 0;    units.T_A = 'K';        label.T_A = 'T_A';      % Arrhenius temperature 8620
par.T_AL   = 90000;   free.T_AL   = 0;   units.T_AL = 'K';       label.T_AL = 'T_AL';      % Arrhenius temperature
...
par.del_M = 0.2429; free.del_M = 1;    units.del_M = '-';      label.del_M = 'del_M';  % shape coefficient

par.zm = 1;       free.zm     = 0;    units.zm = '-';          label.zm = 'zm';          % scaled functional response for 0-var data
