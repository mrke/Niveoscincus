...
% species names
pets = {'Niveoscincus_microlepidotus'};
...
load('results_Niveoscincus_microlepidotus')
par.z=par.z*par.zm;
par.E_Hb=par.E_Hb*par.zm^3;
par.E_Hp=par.E_Hp*par.zm^3;
par.h_a=par.h_a*par.zm^2;
...
csvwrite('DEB_pars_Niveoscincus_microlepidotus.csv',results);