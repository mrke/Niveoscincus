...
%%
function [par, metapar, txt_par, chem] = pars_init_Niveoscincus_ocellatus_highland(metadata)
...
par.kap = 0.5997;      free.kap   = 0;    units.kap = '-';        label.kap = 'kap';      % allocation fraction to soma
...
par.E_G = 7202.5;     free.E_G   = 0;    units.E_G = 'J/cm^3';   label.E_G = '[E_G]';    % spec cost for structure
